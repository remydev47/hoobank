...
const Billing = () => (
  <section id="product" className={layout.sectionReverse}>
    <div className={layout.sectionImg}>
      <img className={style.image} src='/images/bill.png' alt="billing" />
    ...
    <div className={layout.sectionInfo}>
      ...
      <div className={style.image2}>
        <img src='/images/apple.svg' alt="apple-store" className='w-[128px] h-[42px] object-contain mr-5 cursor-pointer'/>
        <img src='/images/google.svg' alt="play_store" className='w-[128px] h-[42px] object-contain  cursor-pointer'/>
      </div>
    </div>
  </section>
)
